...
import static uk.co.electronstudio.sdl2gdx.SDL2ControllerManager.InputPreference.DIRECT_INPUT;
import static uk.co.electronstudio.sdl2gdx.SDL2ControllerManager.InputPreference.RAW_INPUT;
    ...
    public SDL2ControllerManager(InputPreference inputPreference) {
        ...
        try {
            for (int i = 0; i < SDL_Joystick.numJoysticks(); i++) {
                ...
                System.out.printf("Joystick %d: %s\n", Integer.valueOf(i), name != null ? name : "Unknown Joystick");
