 ...
 * 
 * See <a href=
 * "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2c/360_controller.svg/450px-360_controller.svg.png">this
 * image</a> which describes each button and axes.
 * 
 * All codes are for buttons expect the L_STICK_XXX, R_STICK_XXX, L_TRIGGER and
 * R_TRIGGER codes, which are axes.
 * 
 * @author badlogic */
public class Xbox {
	// Buttons
