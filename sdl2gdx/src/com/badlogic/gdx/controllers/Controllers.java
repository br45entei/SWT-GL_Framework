...
/** Provides access to connected {@link Controller} instances. Query the
 * available controllers via {@link #getControllers()}, add
 * and remove global {@link ControllerListener} instances via
 * {@link #addListener(ControllerListener)} and
 * {@link #removeListener(ControllerListener)}. The listeners will be invoked on
 * the rendering thread. The global listeners will
 * be invoked for all events generated by all controllers. Polling a Controller
 * can be done by invoking one of its getter methods.
 * 
 * @author Nathan Sweet */
public class Controllers {
	...
	/** The class name of a preferred {@link ControllerManager}. If this is null
	 * then an appropriate ControllerManager will
	 * automatically be selected. This must be set before any controllers or
	 * managers are found. */
	public static String preferredManager = null;
	
	/** Returns an array of connected {@link Controller} instances. This method
	 * should only be called on the rendering thread.
	 * 
	...
	/** Add a global {@link ControllerListener} that can react to events from
	 * all {@link Controller} instances. The listener will be
	...
	/** Removes a global {@link ControllerListener}. The method must be called
	...
	/** Returns all listeners currently registered. Modifying this array will
