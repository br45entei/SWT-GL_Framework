...
/** Represents a connected controller. Provides methods to query the state of
 * buttons, axes, POVs, sliders and accelerometers on
 * the controller. Multiple {@link ControllerListener} instances can be
 * registered with the Controller to receive events in case
 * the controller's state changes. Listeners will be invoked on the rendering
 * thread.
 * 
 * @author Nathan Sweet */
public interface Controller {
	...
	/** @param sensitivity the accelerometer sensitive, 0 (lowest) to 1
	 *            (highest) */
	 ...
	 * listener will receive calls in case the state of the
